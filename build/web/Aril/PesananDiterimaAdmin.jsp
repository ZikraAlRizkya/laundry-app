...
<html>
  ...
  <body>
        ...
        if ("move".equals(action)) {
          try {
            ...
            try (Connection c = Aril.Model.DBConnection.getConnection();
              ...
              if (ok) {
                flash = "Status berhasil diubah: received → process";
              } else {
    ...
    <div class="content">
      <h1 class="mb-2">
        Pesanan Diterima
        <span class="badge"><%= orders.size() %> received</span>
      </h1>

      <div class="muted mb-4">
        Pesanan sudah diterima (status: <b>received</b>).
        Klik tombol untuk ubah ke <b>process</b>.
      </div>
      ...
      <div class="card">
        ...
        <% } else if (orders.isEmpty()) { %>
          <div class="empty">
            Belum ada pesanan dengan status <b>received</b>.
          </div>
                ...
                <tr>
                  ...
                  <td class="right">
                    <form
                      ...
                      onsubmit="return confirm('Ubah status received → process?');"
                    >
