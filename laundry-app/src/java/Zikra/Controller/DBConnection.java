...
public class DBConnection {
    ...
    public DBConnection(){
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/laundry_db", "root", "");
...
VALUES
('Reguler', 'Pakaian', 7000.00, 'kg', '2 hari'),
('Kilat', 'Pakaian', 12000.00, 'kg', '1 hari'),
('Setrika', 'Pakaian', 5000.00, 'kg', '1 hari');
