...
<html>
  ...
  <body>
    ...
    <%
      String currentStatus = "ready to taken";
        ...
        if ("move".equals(action)) {
          try {
            ...
            try (Connection c = Aril.Model.DBConnection.getConnection();
              ...
              if (ok) {
                flash = "Status berhasil diubah: ready to taken → done";
              } else {
    ...
    <div class="content">
      <h1 class="mb-2">
        ...
        <span class="badge"><%= orders.size() %> ready</span>
      </h1>

      <div class="muted mb-4">
        Status saat ini: <b>ready to taken</b>.
        Klik tombol untuk ubah jadi <b>done</b>.
      </div>
      ...
      <div class="card">
        ...
        <% } else if (orders.isEmpty()) { %>
          <div class="empty">
            Belum ada pesanan dengan status <b>ready to taken</b>.
          </div>
                ...
                <tr>
                  ...
                  <td class="right">
                    <form
                      ...
                      onsubmit="return confirm('Ubah status ready to taken → done?');"
                    >
